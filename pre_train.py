...
from pretraining.nn_layer import softmax_layer, bi_dynamic_rnn, reduce_mean_with_len
from pretraining.att_layer import bilinear_attention_layer
from pretraining.config import *
from pretraining.utils import load_w2v, batch_index, load_inputs
import os


def Pre_train(inputs, sen_len, keep_prob1, keep_prob2, _id='all'):
...
def main(_):
    ...
    prob, att_1_s = Pre_train(inputs_s, sen_len, keep_prob1, keep_prob2, FLAGS.t1)
